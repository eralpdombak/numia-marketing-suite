...
The Developer Problem (Context)
Your audience is time-poor and skims. Every second counts. They're allergic to sales pitches. They respect technical insights and real solutions.
The Golden Rules
What NOT to Do
...
Your dashboard shows wrong balances. Again. You're checking three different provider status pages trying to figure out which one is lagging.
This is what happens when you're duct-taping together multiple data sources. Sound familiar?
How many providers are you juggling right now? Be honest.
Here's what actually fixes it: One API that works across every chain. No more provider juggling. No more "why is only Arbitrum broken" debugging sessions. It's about reclaiming your time and building a reliable product.
...
✅ Even More Specific:
"You're using Alchemy for Ethereum, QuickNode for Solana, and some random RPC for Polygon. Each one has different rate limits. Each one fails differently. You spent Tuesday debugging why only Polygon data was stale."
...
"6 hours debugging vs. shipped 2 features"
"Tuesday: shipping features. Not investigating why Base decided token balances are optional"

The Benefit Formula
[Concrete action] instead of [concrete time-waster]
Examples:

"Debug in 5 minutes" instead of "Debug for 5 hours"
"One source of truth" instead of "Three conflicting dashboards"
"Sleep through the night" instead of "Wake up to alerts"
...
Example: "You're checking three different provider status pages trying to figure out which one is lagging. Sound familiar?"
2. Expand Benefits with "Why It Matters"
Don't just list the benefit. Add the deeper emotional meaning.
❌ Weak: "You spend Tuesday shipping features."
✅ Strong: "You spend Tuesday shipping that new feature instead of investigating why Base suddenly decided token balances are optional. It's about reclaiming your time and building a reliable product."
The "It's about..." sentence elevates it from feature to impact.
3. The Emotional Close (CRITICAL)
Never end with just product name. Always add emotional payoff.
❌ Weak: "That's Numia."
✅ Strong: "That's Numia. It's not just data; it's peace of mind."
Other Emotional Close Examples:

"That's Numia. It's not just an API; it's your weekend back."
"That's Numia. So you can sleep through the night."
"That's Numia. Your weekends stay yours."
"That's Numia. Build features, not workarounds."
"That's Numia. It's not just infrastructure; it's confidence."
"That's Numia. It's not just faster; it's 3am stays quiet."

4. Question Technique (Boost Responses)
...
This increases the likelihood they'll actually answer.
5. The "It's About..." Pattern
...
"It's about sleeping through alerts, not jumping at them."

This connects tactical benefits to strategic/emotional value.
6. Validation Checkpoints Throughout
Sprinkle 1-2 micro-validation phrases after pain points:
Example Flow:
"Your dashboard shows wrong balances. Again. [Pain 1] You're checking three different status pages. [Pain 2] You know this dance. [Validation]"
...
✅ "What's your go-to move when your data provider lags? Wait it out or switch providers?"
...
This is what happens when [root cause]. [Validation phrase].

[Specific question]? [Prompt].

Here's what changes: [Tangible benefit 1]. [Tangible benefit 2]. [Tangible benefit 3]. It's about [emotional reframe].

[Feature summary in one sentence].

That's [Product]. It's not just [feature]; it's [emotional benefit].
Example Using Full Template
You just spent 6 hours debugging why token balances won't update. The code's fine. Alchemy works. QuickNode works. But somehow Polygon is 90 seconds behind.
This is what happens when you're duct-taping together three different data sources. Sound familiar?
How many providers are you juggling right now? Be honest.
Here's what actually changes: One API call. Every chain. Same response time. No more "which provider is lying today" detective work. It's about confidence in your infrastructure, not crossing your fingers.
Single source of truth across 50+ chains. Consistent data. No surprises.
...
Match their energy: casual = casual, technical = technical
Ask follow-up questions to keep conversation going
Never be salesy in comments - just be helpful
Be human: Show personality, empathy, humor

Response Examples
Them: "This hits hard. We're dealing with this right now."
You: "Which part's the biggest pain point for you? The rate limits or the inconsistency?"
Them: "How does this compare to [competitor]?"
You: "Good question. What specific use case are you trying to solve? Happy to break down the differences."
Them: "We built our own solution for this."
You: "Nice! How's that holding up? What was the trickiest part to get right?"
Them: "This is exactly our setup 😭"
You: "😭 is right. How long have you been juggling all three? What finally breaks first for you - rate limits or data lag?"
Common Mistakes to Avoid
The AI Trap
❌ Using the same structure every time
❌ Perfect, templated posts with no personality
❌ Over-explaining simple concepts
❌ Generic transitions and corporate speak
❌ No emotion or specific details
❌ Ending with just "That's [Product]" without emotional payoff
The Sales Trap
❌ Leading with "We built..."
❌ Talking about features before pain
❌ Sounding promotional in the first 75%
❌ Not providing value without the product mention
❌ Being salesy in comments
The Boring Trap
❌ Vague pain points ("providers are frustrating")
❌ Abstract benefits ("better infrastructure")
❌ Generic questions ("What do you think?")
❌ No validation phrases or emotional connection
❌ Same hook pattern repeatedly
The Human Writing Process for LinkedIn

Start with AI draft (if using) - treat it as rough outline
Read out loud - does it sound like you?
Cut 30-40% - be ruthless, every word must earn its place
Add specificity - replace generic with ultra-specific
...
Engagement Benchmarks (What to Aim For)
Good post metrics:

Comments with real experiences shared
Developers tagging teammates
Saves/bookmarks
Shares with added commentary
Comments continuing the conversation (not just "Great post!")

Warning signs:

Lots of likes, no comments
Generic "Thanks for sharing" comments
No saves or shares
Quick scroll-past
